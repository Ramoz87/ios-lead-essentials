...
final class FeedImageDataLoaderWithFallbackCompositeTests: XCTestCase {
    ...
    func test_loadImageData_deliversPrimaryDataOnPrimaryLoaderSuccess() {
        ...
        expect(sut, completeWith: .success(primaryData), when: {
    ...
    func test_loadImageData_deliversFallbackDataOnFallbackLoaderSuccess() {
        ...
        expect(sut, completeWith: .success(fallbackData), when: {
            primaryLoader.complete(with: anyNSError())
    ...
    func test_loadImageData_deliversErrorOnBothPrimaryAndFallbackLoaderFailure() {
        ...
        expect(sut, completeWith: .failure(anyNSError()), when: {
            primaryLoader.complete(with: anyNSError())
    ...
    private func expect(_ sut: FeedImageDataLoader, completeWith expectedResult: FeedImageDataLoader.Result, when action: () -> Void, file: StaticString = #file, line: UInt = #line) {
