...
final class URLSessionHTTPClientTests: XCTestCase {
    ...
    func test_getFromUrl_failedWithError() {
        let error = anyNSError()
        
        let result = resultErrorFor(data: nil, response: nil, error: error) as? NSError
    ...
    func test_getFromUrl_successWithEmptyDataAndResponse() {
        let response = anyHTTPURLResponse()
    ...
    private class URLProtocolStub: URLProtocol {
        ...
        static func onProcessRequest(_ observer: @escaping (URLRequest) -> Void) {
