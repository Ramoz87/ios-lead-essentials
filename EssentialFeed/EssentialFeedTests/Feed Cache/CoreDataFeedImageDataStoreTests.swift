...
class CoreDataFeedImageDataStoreTests: XCTestCase, FeedImageDataStoreSpecs{
    ...
    private func makeSUT(_ test: @Sendable @escaping (CoreDataFeedStore, URL) -> Void, file: StaticString = #file, line: UInt = #line) async throws {
